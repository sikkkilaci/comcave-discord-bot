...
import { listLearningMaterialsForClass } from '../../../services/learningMaterialService.js';
...
const command: Command = {
  data: new SlashCommandBuilder()
    .setName('lernmaterial-anzeigen')
    .setDescription('📚 Zeigt das Lernmaterial einer Klasse an (Standard: die eigene Klasse).')
  ...
  async execute(interaction) {
    ...
    await interaction.reply({
      embeds: [buildLearningMaterialListEmbed(className, materials)],
